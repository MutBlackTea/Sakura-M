...
<#if settings.footer_ssl!false && settings.footer_ssl_url != "">
        <!-- SSL证书 -->
<div id="cc-myssl-id">
      <a href="https://myssl.com/${settings.footer_ssl_url!}?from=mysslid"><img src="https://static.myssl.com/res/images/myssl-id3.png" alt="" style="max-height:50px;display:block;margin:0 auto"></ a>
      </div>
</#if> 
</footer><!-- #colophon -->
<div class="openNav">
